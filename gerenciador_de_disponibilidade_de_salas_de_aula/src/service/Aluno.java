...
public class Aluno extends Pessoa 
{
    ...
    {
        File Insti = new File("diretorio//inst//"+this.Inst.getNome(), "aluno");
    ...
    {
        File Insti = new File("diretorio//inst//"+this.Inst.getNome()+"//aluno//"+this.getNome(),"turmas");
        boolean jk = Insti.mkdir();
    }
    ...
    public void salvaLisTurma(Turma T)
    {
        try 
        {
            FileWriter lt = new FileWriter("diretorio//inst//"+this.Inst.getNome()+"//pessoa//aluno//"+this.getNome()+"//turmas//lista.txt",true);
    ...
    public void salvaLisAluno()
    {
        try 
        {
            FileWriter lt = new FileWriter("diretorio//inst//"+this.Inst.getNome()+"//aluno//lista.txt",true);
            PrintWriter plt = new PrintWriter(lt);
    ...
    public String SalvarTurma(Turma T)
    {
        try 
        {
            FileWriter fwT = new FileWriter("diretorio//inst//"+this.Inst.getNome()+"//aluno//"+this.getNome()+"//turmas//"+T.getNome()+".txt");
        ...
        try 
        {
           FileWriter fwS = new FileWriter("diretorio//disc//"+T.getDisciplina().getNome()+"//"+T.getNome()+"//aluno//"+this.getNome()+".txt",true);
           PrintWriter pwS = new PrintWriter(fwS);
           pwS.println(this.getNome());
           pwS.flush();
           pwS.close();
           fwS.close();
        } 
    ...
    public String Salvar()
    {
        ...
        try 
        {
            FileWriter fw = new FileWriter("diretorio//inst//"+this.Inst.getNome()+"//pessoa//aluno//"+this.getNome()+"//"+this.getNome()+".txt", true);
